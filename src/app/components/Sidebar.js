...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`relative min-h-screen bg-slate-900 text-slate-300 transition-all duration-300 ease-in-out flex flex-col justify-between border-r border-slate-800 ${
    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center space-x-3 overflow-hidden">
          ...
          {!isCollapsed && (
            <span className="font-bold text-xl text-white tracking-wide transition-opacity duration-200">
